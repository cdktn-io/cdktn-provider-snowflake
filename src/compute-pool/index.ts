...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/compute_pool
...
export class ComputePool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/compute_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/compute_pool snowflake_compute_pool} Resource
  *
  * @param scope The scope in which to define this construct
