...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/compute_pool
...
export interface ComputePoolConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly backupInstanceFamilies?: string[];
  /**
...
export class ComputePool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/compute_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ComputePoolConfig) {
    ...
    this._backupInstanceFamilies = config.backupInstanceFamilies;
  ...
  // backup_instance_families - computed: false, optional: true, required: false
  private _backupInstanceFamilies?: string[]; 
  public get backupInstanceFamilies() {
    return this.getListAttribute('backup_instance_families');
  }
  public set backupInstanceFamilies(value: string[]) {
    this._backupInstanceFamilies = value;
  }
  public resetBackupInstanceFamilies() {
    this._backupInstanceFamilies = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get backupInstanceFamiliesInput() {
    return this._backupInstanceFamilies;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      backup_instance_families: cdktn.listMapper(cdktn.stringToTerraform, false)(this._backupInstanceFamilies),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      backup_instance_families: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._backupInstanceFamilies),
        isBlock: false,
        type: "list",
