...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.13.0/docs/data-sources/connections
...
export interface DataSnowflakeConnectionsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataSnowflakeConnectionsConnectionsShowOutputOutputReference extends cdktn.ComplexObject {
...
export class DataSnowflakeConnectionsConnectionsShowOutputList extends cdktn.ComplexList {
...
export class DataSnowflakeConnectionsConnectionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeConnectionsConnectionsList extends cdktn.ComplexList {
...
*/
export class DataSnowflakeConnections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.13.0/docs/data-sources/connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_connections", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.13.0/docs/data-sources/connections snowflake_connections} Data Source
  *
  * @param scope The scope in which to define this construct
