...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/cortex_agent
...
export class CortexAgent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CortexAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/cortex_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/cortex_agent snowflake_cortex_agent} Resource
  *
  * @param scope The scope in which to define this construct
