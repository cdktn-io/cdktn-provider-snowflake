...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/user_authentication_policy_attachment
...
export interface UserAuthenticationPolicyAttachmentConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly id?: string;
  /**
  * User name of the user you want to attach the authentication policy to. Due to technical limitations (read more [here](../guides/identifiers_rework_design_decisions#known-limitations-and-identifier-recommendations)), avoid using pipes (`|`).
  *
...
export class UserAuthenticationPolicyAttachment extends cdktn.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/user_authentication_policy_attachment snowflake_user_authentication_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
