...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/tag
...
export class TagShowOutputOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // on_conflict - computed: true, optional: false, required: false
  public get onConflict() {
    return this.getStringAttribute('on_conflict');
  }
...
export class Tag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Tag that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/tag#import import section} in the documentation of this resource for the id to use
