...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/stream_on_view
...
export class StreamOnView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamOnView that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/stream_on_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/stream_on_view snowflake_stream_on_view} Resource
  *
  * @param scope The scope in which to define this construct
