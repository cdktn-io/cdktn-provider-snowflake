...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/saml2_integration
...
export class Saml2Integration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Saml2Integration that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/saml2_integration#import import section} in the documentation of this resource for the id to use
