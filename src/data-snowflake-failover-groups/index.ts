...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/failover_groups
...
export interface DataSnowflakeFailoverGroupsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataSnowflakeFailoverGroupsFailoverGroupsOutputReference extends cdktn.ComplexObject {
...
export class DataSnowflakeFailoverGroupsFailoverGroupsList extends cdktn.ComplexList {
...
*/
export class DataSnowflakeFailoverGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeFailoverGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/failover_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_failover_groups", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/failover_groups snowflake_failover_groups} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      in_account: cdktn.stringToTerraform(this._inAccount),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      in_account: {
        value: cdktn.stringToHclTerraform(this._inAccount),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
