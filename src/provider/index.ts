...
export interface SnowflakeProviderConfig {
  ...
  */
  readonly tfcWorkloadIdentityTokenTag?: string;
  /**
...
export class SnowflakeProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: SnowflakeProviderConfig = {}) {
    ...
    this._tfcWorkloadIdentityTokenTag = config.tfcWorkloadIdentityTokenTag;
  ...
  // tfc_workload_identity_token_tag - computed: false, optional: true, required: false
  private _tfcWorkloadIdentityTokenTag?: string; 
  public get tfcWorkloadIdentityTokenTag() {
    return this._tfcWorkloadIdentityTokenTag;
  }
  public set tfcWorkloadIdentityTokenTag(value: string | undefined) {
    this._tfcWorkloadIdentityTokenTag = value;
  }
  public resetTfcWorkloadIdentityTokenTag() {
    this._tfcWorkloadIdentityTokenTag = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get tfcWorkloadIdentityTokenTagInput() {
    return this._tfcWorkloadIdentityTokenTag;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tfc_workload_identity_token_tag: cdktn.stringToTerraform(this._tfcWorkloadIdentityTokenTag),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tfc_workload_identity_token_tag: {
        value: cdktn.stringToHclTerraform(this._tfcWorkloadIdentityTokenTag),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
