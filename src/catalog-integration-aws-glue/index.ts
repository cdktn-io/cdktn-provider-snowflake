...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/catalog_integration_aws_glue
...
export class CatalogIntegrationAwsGlue extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CatalogIntegrationAwsGlue that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/catalog_integration_aws_glue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/catalog_integration_aws_glue snowflake_catalog_integration_aws_glue} Resource
  *
  * @param scope The scope in which to define this construct
