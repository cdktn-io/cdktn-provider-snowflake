...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/procedure_python
...
export interface ProcedurePythonParametersLogEventLevel {
}

export function procedurePythonParametersLogEventLevelToTerraform(struct?: ProcedurePythonParametersLogEventLevel): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function procedurePythonParametersLogEventLevelToHclTerraform(struct?: ProcedurePythonParametersLogEventLevel): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ProcedurePythonParametersLogEventLevelOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ProcedurePythonParametersLogEventLevel | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ProcedurePythonParametersLogEventLevel | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class ProcedurePythonParametersLogEventLevelList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): ProcedurePythonParametersLogEventLevelOutputReference {
    return new ProcedurePythonParametersLogEventLevelOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ProcedurePythonParametersOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _logEventLevel = new ProcedurePythonParametersLogEventLevelList(this, "log_event_level", false);
...
export class ProcedurePython extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcedurePython that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/procedure_python#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/procedure_python snowflake_procedure_python} Resource
  *
  * @param scope The scope in which to define this construct
