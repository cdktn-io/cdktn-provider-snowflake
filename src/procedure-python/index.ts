...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.17.0/docs/resources/procedure_python
...
export class ProcedurePython extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcedurePython that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.17.0/docs/resources/procedure_python#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.17.0/docs/resources/procedure_python snowflake_procedure_python} Resource
  *
  * @param scope The scope in which to define this construct
