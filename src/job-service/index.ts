...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/job_service
...
export class JobService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing JobService that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/job_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/job_service snowflake_job_service} Resource
  *
  * @param scope The scope in which to define this construct
