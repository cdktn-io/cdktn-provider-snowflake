...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.14.0/docs/resources/function_sql
...
export class FunctionSql extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionSql that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.14.0/docs/resources/function_sql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.14.0/docs/resources/function_sql snowflake_function_sql} Resource
  *
  * @param scope The scope in which to define this construct
