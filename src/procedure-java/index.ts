...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/procedure_java
...
export interface ProcedureJavaParametersLogEventLevel {
}

export function procedureJavaParametersLogEventLevelToTerraform(struct?: ProcedureJavaParametersLogEventLevel): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function procedureJavaParametersLogEventLevelToHclTerraform(struct?: ProcedureJavaParametersLogEventLevel): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ProcedureJavaParametersLogEventLevelOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ProcedureJavaParametersLogEventLevel | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ProcedureJavaParametersLogEventLevel | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class ProcedureJavaParametersLogEventLevelList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): ProcedureJavaParametersLogEventLevelOutputReference {
    return new ProcedureJavaParametersLogEventLevelOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ProcedureJavaParametersOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _logEventLevel = new ProcedureJavaParametersLogEventLevelList(this, "log_event_level", false);
...
export class ProcedureJava extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcedureJava that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/procedure_java#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/procedure_java snowflake_procedure_java} Resource
  *
  * @param scope The scope in which to define this construct
