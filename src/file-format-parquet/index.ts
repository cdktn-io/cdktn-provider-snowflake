...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/file_format_parquet
...
export interface FileFormatParquetConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: FileFormatParquetTimeouts;
}
export interface FileFormatParquetDescribeOutput {
}

export function fileFormatParquetDescribeOutputToTerraform(struct?: FileFormatParquetDescribeOutput): any {
...
export function fileFormatParquetDescribeOutputToHclTerraform(struct?: FileFormatParquetDescribeOutput): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FileFormatParquetDescribeOutputOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FileFormatParquetDescribeOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: FileFormatParquetDescribeOutput | undefined) {
    if (value === undefined) {
...
export class FileFormatParquetDescribeOutputList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): FileFormatParquetDescribeOutputOutputReference {
    return new FileFormatParquetDescribeOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface FileFormatParquetShowOutput {
}

export function fileFormatParquetShowOutputToTerraform(struct?: FileFormatParquetShowOutput): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function fileFormatParquetShowOutputToHclTerraform(struct?: FileFormatParquetShowOutput): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FileFormatParquetShowOutputOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FileFormatParquetShowOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: FileFormatParquetShowOutput | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class FileFormatParquetShowOutputList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): FileFormatParquetShowOutputOutputReference {
    return new FileFormatParquetShowOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface FileFormatParquetTimeouts {
  /**
...
export function fileFormatParquetTimeoutsToTerraform(struct?: FileFormatParquetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function fileFormatParquetTimeoutsToHclTerraform(struct?: FileFormatParquetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FileFormatParquetTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FileFormatParquetTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FileFormatParquetTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class FileFormatParquet extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "snowflake_file_format_parquet";
  ...
  * @param importToId The construct id used in the generated config for the FileFormatParquet to import
  * @param importFromId The id of the existing FileFormatParquet that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/file_format_parquet#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FileFormatParquet to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_file_format_parquet", importId: importFromId, provider });
      }
  ...
  * @param options FileFormatParquetConfig
  */
  public constructor(scope: Construct, id: string, config: FileFormatParquetConfig) {
    super(scope, id, {
      terraformResourceType: 'snowflake_file_format_parquet',
    ...
    this._useLogicalType = config.useLogicalType;
    this._useVectorizedScanner = config.useVectorizedScanner;
  ...
  private _describeOutput = new FileFormatParquetDescribeOutputList(this, "describe_output", false);
  ...
  private _showOutput = new FileFormatParquetShowOutputList(this, "show_output", false);
  ...
  private _timeouts = new FileFormatParquetTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: FileFormatParquetTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      binary_as_text: cdktn.stringToTerraform(this._binaryAsText),
      ...
      use_logical_type: cdktn.stringToTerraform(this._useLogicalType),
      use_vectorized_scanner: cdktn.stringToTerraform(this._useVectorizedScanner),
      timeouts: fileFormatParquetTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      binary_as_text: {
        value: cdktn.stringToHclTerraform(this._binaryAsText),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      use_logical_type: {
        value: cdktn.stringToHclTerraform(this._useLogicalType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      use_vectorized_scanner: {
        value: cdktn.stringToHclTerraform(this._useVectorizedScanner),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      timeouts: {
        value: fileFormatParquetTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "FileFormatParquetTimeouts",
      },
    };
