...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/execute
...
export class Execute extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Execute that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/execute#import import section} in the documentation of this resource for the id to use
