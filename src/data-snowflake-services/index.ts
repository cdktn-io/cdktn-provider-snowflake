...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/services
...
export interface DataSnowflakeServicesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataSnowflakeServicesServicesDescribeOutputOutputReference extends cdktn.ComplexObject {
...
export class DataSnowflakeServicesServicesDescribeOutputList extends cdktn.ComplexList {
...
export class DataSnowflakeServicesServicesShowOutputOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeServicesServicesShowOutputList extends cdktn.ComplexList {
...
export class DataSnowflakeServicesServicesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeServicesServicesList extends cdktn.ComplexList {
...
export function dataSnowflakeServicesInToTerraform(struct?: DataSnowflakeServicesInOutputReference | DataSnowflakeServicesIn): any {
  ...
  return {
    ...
    compute_pool: cdktn.stringToTerraform(struct!.computePool),
...
export function dataSnowflakeServicesInToHclTerraform(struct?: DataSnowflakeServicesInOutputReference | DataSnowflakeServicesIn): any {
  ...
  const attrs = {
    ...
    compute_pool: {
      value: cdktn.stringToHclTerraform(struct!.computePool),
      isBlock: false,
      type: "simple",
...
export class DataSnowflakeServicesInOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeServicesLimitOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataSnowflakeServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/services#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_services", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/services snowflake_services} Data Source
  *
  * @param scope The scope in which to define this construct
