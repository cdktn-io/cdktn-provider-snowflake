...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/current_account
...
export interface CurrentAccountConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function currentAccountTimeoutsToTerraform(struct?: CurrentAccountTimeouts | cdktn.IResolvable): any {
...
export function currentAccountTimeoutsToHclTerraform(struct?: CurrentAccountTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class CurrentAccountTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CurrentAccountTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: CurrentAccountTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class CurrentAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CurrentAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/current_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/current_account snowflake_current_account} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      authentication_policy: cdktn.stringToTerraform(this._authenticationPolicy),
      ...
      feature_policy: cdktn.stringToTerraform(this._featurePolicy),
      ...
      packages_policy: cdktn.stringToTerraform(this._packagesPolicy),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      authentication_policy: {
        value: cdktn.stringToHclTerraform(this._authenticationPolicy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      feature_policy: {
        value: cdktn.stringToHclTerraform(this._featurePolicy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      packages_policy: {
        value: cdktn.stringToHclTerraform(this._packagesPolicy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
