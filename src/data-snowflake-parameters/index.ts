...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/parameters
...
export interface DataSnowflakeParametersConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataSnowflakeParametersParametersOutputReference extends cdktn.ComplexObject {
...
export class DataSnowflakeParametersParametersList extends cdktn.ComplexList {
...
*/
export class DataSnowflakeParameters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeParameters that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/parameters#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_parameters", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/parameters snowflake_parameters} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameter_type: cdktn.stringToTerraform(this._parameterType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      parameter_type: {
        value: cdktn.stringToHclTerraform(this._parameterType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
