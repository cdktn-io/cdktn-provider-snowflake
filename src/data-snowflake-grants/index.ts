...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/grants
...
export class DataSnowflakeGrantsGrantsOutputReference extends cdktn.ComplexObject {
...
export class DataSnowflakeGrantsGrantsList extends cdktn.ComplexList {
...
export class DataSnowflakeGrantsFutureGrantsInOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataSnowflakeGrantsFutureGrantsToToTerraform(struct?: DataSnowflakeGrantsFutureGrantsToOutputReference | DataSnowflakeGrantsFutureGrantsTo): any {
  ...
  return {
    account_role: cdktn.stringToTerraform(struct!.accountRole),
...
export function dataSnowflakeGrantsFutureGrantsToToHclTerraform(struct?: DataSnowflakeGrantsFutureGrantsToOutputReference | DataSnowflakeGrantsFutureGrantsTo): any {
  ...
  const attrs = {
    account_role: {
      value: cdktn.stringToHclTerraform(struct!.accountRole),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class DataSnowflakeGrantsFutureGrantsToOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataSnowflakeGrantsGrantsOfToTerraform(struct?: DataSnowflakeGrantsGrantsOfOutputReference | DataSnowflakeGrantsGrantsOf): any {
  ...
  return {
    account_role: cdktn.stringToTerraform(struct!.accountRole),
    application_role: cdktn.stringToTerraform(struct!.applicationRole),
    database_role: cdktn.stringToTerraform(struct!.databaseRole),
    share: cdktn.stringToTerraform(struct!.share),
  }
}
...
export function dataSnowflakeGrantsGrantsOfToHclTerraform(struct?: DataSnowflakeGrantsGrantsOfOutputReference | DataSnowflakeGrantsGrantsOf): any {
  ...
  const attrs = {
    ...
    application_role: {
      value: cdktn.stringToHclTerraform(struct!.applicationRole),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    share: {
      value: cdktn.stringToHclTerraform(struct!.share),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class DataSnowflakeGrantsGrantsOfOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeGrantsGrantsOnOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeGrantsGrantsToShareOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeGrantsGrantsToOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeGrants extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeGrants that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/grants#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_grants", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.15.0/docs/data-sources/grants snowflake_grants} Data Source
  *
  * @param scope The scope in which to define this construct
