...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/user_session_policy_attachment
...
export interface UserSessionPolicyAttachmentConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * User name of the user you want to attach the session policy to. Due to technical limitations (read more [here](../guides/identifiers_rework_design_decisions#known-limitations-and-identifier-recommendations)), avoid using pipes (`|`).
  *
