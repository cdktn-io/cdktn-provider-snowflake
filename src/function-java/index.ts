...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/function_java
...
export interface FunctionJavaParametersLogEventLevel {
}

export function functionJavaParametersLogEventLevelToTerraform(struct?: FunctionJavaParametersLogEventLevel): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function functionJavaParametersLogEventLevelToHclTerraform(struct?: FunctionJavaParametersLogEventLevel): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FunctionJavaParametersLogEventLevelOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FunctionJavaParametersLogEventLevel | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: FunctionJavaParametersLogEventLevel | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class FunctionJavaParametersLogEventLevelList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): FunctionJavaParametersLogEventLevelOutputReference {
    return new FunctionJavaParametersLogEventLevelOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class FunctionJavaParametersOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _logEventLevel = new FunctionJavaParametersLogEventLevelList(this, "log_event_level", false);
...
export class FunctionJava extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionJava that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.20.0/docs/resources/function_java#import import section} in the documentation of this resource for the id to use
