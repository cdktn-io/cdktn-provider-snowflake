...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.14.0/docs/data-sources/cortex_search_services
...
export interface DataSnowflakeCortexSearchServicesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataSnowflakeCortexSearchServicesCortexSearchServicesOutputReference extends cdktn.ComplexObject {
...
export class DataSnowflakeCortexSearchServicesCortexSearchServicesList extends cdktn.ComplexList {
...
export class DataSnowflakeCortexSearchServicesInOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataSnowflakeCortexSearchServicesLimitOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataSnowflakeCortexSearchServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeCortexSearchServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.14.0/docs/data-sources/cortex_search_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_cortex_search_services", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.14.0/docs/data-sources/cortex_search_services snowflake_cortex_search_services} Data Source
  *
  * @param scope The scope in which to define this construct
