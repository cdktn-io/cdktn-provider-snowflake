...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/oauth_integration_for_partner_applications
...
export interface OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStruct {
}

export function oauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructToTerraform(struct?: OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStruct): any {
...
export function oauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructToHclTerraform(struct?: OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStruct): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStruct | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStruct | undefined) {
    if (value === undefined) {
...
export class OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructOutputReference {
    return new OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class OauthIntegrationForPartnerApplicationsDescribeOutputOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _allowedRolesList = new OauthIntegrationForPartnerApplicationsDescribeOutputAllowedRolesListStructList(this, "allowed_roles_list", false);
...
export class OauthIntegrationForPartnerApplications extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthIntegrationForPartnerApplications that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/oauth_integration_for_partner_applications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/oauth_integration_for_partner_applications snowflake_oauth_integration_for_partner_applications} Resource
  *
  * @param scope The scope in which to define this construct
