...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/data-sources/system_get_snowflake_platform_info
...
export class DataSnowflakeSystemGetSnowflakePlatformInfo extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeSystemGetSnowflakePlatformInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/data-sources/system_get_snowflake_platform_info#import import section} in the documentation of this resource for the id to use
