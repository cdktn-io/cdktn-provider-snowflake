...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/stage_external_s3
...
export function stageExternalS3DirectoryToTerraform(struct?: StageExternalS3DirectoryOutputReference | StageExternalS3Directory): any {
  ...
  return {
    ...
    aws_sns_topic: cdktn.stringToTerraform(struct!.awsSnsTopic),
...
export function stageExternalS3DirectoryToHclTerraform(struct?: StageExternalS3DirectoryOutputReference | StageExternalS3Directory): any {
  ...
  const attrs = {
    ...
    aws_sns_topic: {
      value: cdktn.stringToHclTerraform(struct!.awsSnsTopic),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class StageExternalS3DirectoryOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StageExternalS3Directory | undefined {
    ...
    if (this._awsSnsTopic !== undefined) {
      hasAnyValues = true;
      internalValueResult.awsSnsTopic = this._awsSnsTopic;
    }
  ...
  public set internalValue(value: StageExternalS3Directory | undefined) {
    if (value === undefined) {
      ...
      this._awsSnsTopic = value.awsSnsTopic;
...
export class StageExternalS3 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StageExternalS3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/stage_external_s3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.19.0/docs/resources/stage_external_s3 snowflake_stage_external_s3} Resource
  *
  * @param scope The scope in which to define this construct
