...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/storage_integration_aws
...
export class StorageIntegrationAws extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageIntegrationAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/storage_integration_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.16.0/docs/resources/storage_integration_aws snowflake_storage_integration_aws} Resource
  *
  * @param scope The scope in which to define this construct
