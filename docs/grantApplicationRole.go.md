...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/grantapplicationrole"
...
&grantapplicationrole.GrantApplicationRoleConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.grantApplicationRole.GrantApplicationRoleTimeouts,
}
```
