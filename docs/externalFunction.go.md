...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/externalfunction"
...
&externalfunction.ExternalFunctionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.externalFunction.ExternalFunctionTimeouts,
}
```
