...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/computepool"
...
&computepool.ComputePoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake.computePool.ComputePoolTimeouts,
}
```
