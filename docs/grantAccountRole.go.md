...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/grantaccountrole"
...
&grantaccountrole.GrantAccountRoleConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.grantAccountRole.GrantAccountRoleTimeouts,
	UserName: *string,
}
```
