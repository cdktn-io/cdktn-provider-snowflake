...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/gitrepository"
...
&gitrepository.GitRepositoryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake.gitRepository.GitRepositoryTimeouts,
}
```
