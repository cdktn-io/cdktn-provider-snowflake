...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v17/functionsql"
...
&functionsql.FunctionSqlConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v17.functionSql.FunctionSqlTimeouts,
	TraceLevel: *string,
}
```
