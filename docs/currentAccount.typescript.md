...
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.cortexCodeCliDailyEstCreditLimitPerUserInput">cortexCodeCliDailyEstCreditLimitPerUserInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.cortexCodeDesktopDailyEstCreditLimitPerUserInput">cortexCodeDesktopDailyEstCreditLimitPerUserInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.cortexCodeSnowsightDailyEstCreditLimitPerUserInput">cortexCodeSnowsightDailyEstCreditLimitPerUserInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.enablePerAccountAppServicePrivatelinkUrlInput">enablePerAccountAppServicePrivatelinkUrlInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.cortexCodeCliDailyEstCreditLimitPerUser">cortexCodeCliDailyEstCreditLimitPerUser</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.cortexCodeDesktopDailyEstCreditLimitPerUser">cortexCodeDesktopDailyEstCreditLimitPerUser</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.cortexCodeSnowsightDailyEstCreditLimitPerUser">cortexCodeSnowsightDailyEstCreditLimitPerUser</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccount.property.enablePerAccountAppServicePrivatelinkUrl">enablePerAccountAppServicePrivatelinkUrl</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccountConfig.property.cortexCodeCliDailyEstCreditLimitPerUser">cortexCodeCliDailyEstCreditLimitPerUser</a></code> | <code>number</code> | Daily estimated credit limit per user for Cortex Code CLI usage. |
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccountConfig.property.cortexCodeDesktopDailyEstCreditLimitPerUser">cortexCodeDesktopDailyEstCreditLimitPerUser</a></code> | <code>number</code> | Daily estimated credit limit per user for Cortex Code Desktop usage. |
| <code><a href="#@cdktn/provider-snowflake.currentAccount.CurrentAccountConfig.property.cortexCodeSnowsightDailyEstCreditLimitPerUser">cortexCodeSnowsightDailyEstCreditLimitPerUser</a></code> | <code>number</code> | Daily estimated credit limit per user for Cortex Code Snowsight usage. |
