...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/fileformatxml"
...
&fileformatxml.FileFormatXmlConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.fileFormatXml.FileFormatXmlTimeouts,
}
```
