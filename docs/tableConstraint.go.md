...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/tableconstraint"
...
&tableconstraint.TableConstraintConfig {
	...
	Enable: interface{},
	Enforced: interface{},
	ForeignKeyProperties: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.tableConstraint.TableConstraintForeignKeyProperties,
	Id: *string,
	Initially: *string,
	Rely: interface{},
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.tableConstraint.TableConstraintTimeouts,
	Validate: interface{},
}
```
...
| <code><a href="#@cdktn/provider-snowflake.tableConstraint.TableConstraintConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/table_constraint#id TableConstraint#id}. |
...
&tableconstraint.TableConstraintForeignKeyProperties {
	References: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.tableConstraint.TableConstraintForeignKeyPropertiesReferences,
	Match: *string,
	OnDelete: *string,
	OnUpdate: *string,
}
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-snowflake.tableConstraint.TableConstraintTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/table_constraint#create TableConstraint#create}. |
| <code><a href="#@cdktn/provider-snowflake.tableConstraint.TableConstraintTimeouts.property.delete">Delete</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/table_constraint#delete TableConstraint#delete}. |
| <code><a href="#@cdktn/provider-snowflake.tableConstraint.TableConstraintTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/table_constraint#read TableConstraint#read}. |
| <code><a href="#@cdktn/provider-snowflake.tableConstraint.TableConstraintTimeouts.property.update">Update</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs/resources/table_constraint#update TableConstraint#update}. |
