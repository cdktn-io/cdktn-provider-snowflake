...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v17/icebergtablefromawsglue"
...
&icebergtablefromawsglue.IcebergTableFromAwsGlueConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v17.icebergTableFromAwsGlue.IcebergTableFromAwsGlueTimeouts,
}
```
