...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/userpublickeys"
...
&userpublickeys.UserPublicKeysConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.userPublicKeys.UserPublicKeysTimeouts,
}
```
