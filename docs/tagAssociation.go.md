...
```go
import "github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18/tagassociation"
...
&tagassociation.TagAssociationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-snowflake-go/snowflake/v18.tagAssociation.TagAssociationTimeouts,
}
```
