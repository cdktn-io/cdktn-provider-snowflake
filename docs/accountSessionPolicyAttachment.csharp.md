...
new AccountSessionPolicyAttachment(Construct Scope, string Id, AccountSessionPolicyAttachmentConfig Config);
```
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.resetForAllPersonUsers">ResetForAllPersonUsers</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.resetForAllServiceUsers">ResetForAllServiceUsers</a></code> | *No description.* |
...
```csharp
private void PutTimeouts(AccountSessionPolicyAttachmentTimeouts Value)
```
...
##### `ResetForAllPersonUsers` <a name="ResetForAllPersonUsers" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.resetForAllPersonUsers"></a>

```csharp
private void ResetForAllPersonUsers()
```

##### `ResetForAllServiceUsers` <a name="ResetForAllServiceUsers" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.resetForAllServiceUsers"></a>

```csharp
private void ResetForAllServiceUsers()
```
...
AccountSessionPolicyAttachment.IsConstruct(object X);
```
...
AccountSessionPolicyAttachment.IsTerraformElement(object X);
```
...
AccountSessionPolicyAttachment.IsTerraformResource(object X);
```
...
AccountSessionPolicyAttachment.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllPersonUsersInput">ForAllPersonUsersInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllServiceUsersInput">ForAllServiceUsersInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllPersonUsers">ForAllPersonUsers</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllServiceUsers">ForAllServiceUsers</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public AccountSessionPolicyAttachmentTimeoutsOutputReference Timeouts { get; }
```
...
##### `ForAllPersonUsersInput`<sup>Optional</sup> <a name="ForAllPersonUsersInput" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllPersonUsersInput"></a>

```csharp
public bool|IResolvable ForAllPersonUsersInput { get; }
```
...
##### `ForAllServiceUsersInput`<sup>Optional</sup> <a name="ForAllServiceUsersInput" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllServiceUsersInput"></a>

```csharp
public bool|IResolvable ForAllServiceUsersInput { get; }
```
...
```csharp
public IResolvable|AccountSessionPolicyAttachmentTimeouts TimeoutsInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentTimeouts">AccountSessionPolicyAttachmentTimeouts</a>

---

##### `ForAllPersonUsers`<sup>Required</sup> <a name="ForAllPersonUsers" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllPersonUsers"></a>

```csharp
public bool|IResolvable ForAllPersonUsers { get; }
```
...
##### `ForAllServiceUsers`<sup>Required</sup> <a name="ForAllServiceUsers" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachment.property.forAllServiceUsers"></a>

```csharp
public bool|IResolvable ForAllServiceUsers { get; }
```
...
new AccountSessionPolicyAttachmentConfig {
    ...
    bool|IResolvable ForAllPersonUsers = null,
    bool|IResolvable ForAllServiceUsers = null,
    string Id = null,
    AccountSessionPolicyAttachmentTimeouts Timeouts = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.forAllPersonUsers">ForAllPersonUsers</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | If true, attaches the session policy to all person users in the current account. |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.forAllServiceUsers">ForAllServiceUsers</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | If true, attaches the session policy to all service users in the current account. |
...
##### `ForAllPersonUsers`<sup>Optional</sup> <a name="ForAllPersonUsers" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.forAllPersonUsers"></a>

```csharp
public bool|IResolvable ForAllPersonUsers { get; set; }
```
...
##### `ForAllServiceUsers`<sup>Optional</sup> <a name="ForAllServiceUsers" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentConfig.property.forAllServiceUsers"></a>

```csharp
public bool|IResolvable ForAllServiceUsers { get; set; }
```
...
```csharp
public AccountSessionPolicyAttachmentTimeouts Timeouts { get; set; }
```
...
new AccountSessionPolicyAttachmentTimeouts {
    string Create = null,
    string Delete = null,
    string Read = null,
    string Update = null
...
new AccountSessionPolicyAttachmentTimeoutsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentTimeoutsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-snowflake.accountSessionPolicyAttachment.AccountSessionPolicyAttachmentTimeoutsOutputReference.resolve.parameter._context"></a>
...
```csharp
public IResolvable|AccountSessionPolicyAttachmentTimeouts InternalValue { get; }
```
