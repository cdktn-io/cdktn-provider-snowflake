...
# CDKTN prebuilt bindings for snowflakedb/snowflake provider version 2.18.0

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/2.18.0)
